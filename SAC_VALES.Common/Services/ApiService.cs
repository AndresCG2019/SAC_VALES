...
namespace SAC_VALES.Common.Services
{
    public class ApiService : IApiService
    {
        ...
        async Task<Response> IApiService.MarcarPago(string urlBase, string servicePrefix, string controller)
        {
            try
            {
        ...
        public async Task<Response> GetClientsByDist(
          string urlBase,
          string servicePrefix,
          string controller,
          ClientesByDistRequest request)
        {
            try
            {
                string requestString = JsonConvert.SerializeObject(request);
                ...
                List<ClieResponse> clienteResponse = JsonConvert.DeserializeObject<List<ClieResponse>>(result);
                return new Response
                {
                    IsSuccess = true,
                    Result = clienteResponse
                };
            }
            catch (Exception ex)
            {
